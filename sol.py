...
img_data, image_size, img_tree, image  = img.imgSetUp(file)
img_quads = []
img_codes = []
N_max = 20
w = []
...
for N in range(4,N_max):
    if found == True:
        break
    img_quads, img_codes = img.generateQuads(N, img_data, image_size, img_quads, img_codes)
